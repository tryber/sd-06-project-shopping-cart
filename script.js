...
function setLocalStorage() {
  ...
  console.log(cartList.innerHTML, 'cartList-get');
}
...
function fetchList() {
  ...
  console.log(title, 'title', loading, 'loading');
